...
JOYSTICK = scale(load(path("Space Wars assets", "Pixel-Joystick.png")),(75,75))
YELLOWBUTTON = scale(load(path("Space Wars assets", "Pixel-Yellow-Button.png")),(75,75))
BLUEBUTTON = scale(load(path("Space Wars assets", "Pixel-Blue-Button.png")),(75,75))
...
def main_menu():
    ...
    while active:
        ...
        screen.blit(JOYSTICK,(418,372))
        screen.blit(YELLOWBUTTON,(713,390))
        
        if counter < 15:
            screen.blit(instruction2,(WIDTH/2-(instruction2.get_width()/2),470))
            screen.blit(YELLOWBUTTON,(588,460))
