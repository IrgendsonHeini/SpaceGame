...
SLAVE_I             = load(os.path.join("Space Wars assets", "Slave-I.png"))
...
EXPLOSION_01 = scale(load(os.path.join("Space Wars assets", "Explosion01.png")),(SMALL,SMALL))
EXPLOSION_02 = scale(load(os.path.join("Space Wars assets", "Explosion02.png")),(SMALL,SMALL))
EXPLOSION_03 = scale(load(os.path.join("Space Wars assets", "Explosion03.png")),(SMALL,SMALL))
EXPLOSION_04 = scale(load(os.path.join("Space Wars assets", "Explosion04.png")),(SMALL,SMALL))
EXPLOSION_05 = scale(load(os.path.join("Space Wars assets", "Explosion05.png")),(SMALL,SMALL))
EXPLOSION_06 = scale(load(os.path.join("Space Wars assets", "Explosion06.png")),(SMALL,SMALL))
EXPLOSION_07 = scale(load(os.path.join("Space Wars assets", "Explosion07.png")),(SMALL,SMALL))
EXPLOSION_08 = scale(load(os.path.join("Space Wars assets", "Explosion08.png")),(SMALL,SMALL))
EXPLOSION_09 = scale(load(os.path.join("Space Wars assets", "Explosion09.png")),(SMALL,SMALL))
...
# Hintergrund
BG = scale(load(os.path.join("Space Wars assets", "Hintergrund.jpg")),(WIDTH,HEIGHT))
...
class DeathrayExplosion(Ship):
    ...
    def __init__(self,x,y,hp = 1):
        self.ship_img = EXPLOSION[self.counter]
        self.attack = 30
    ...
    def draw(self,x,y):
        screen.blit(EXPLOSION[self.counter],(x,y))       
        self.counter += 1   
            ...
            def spawn_imperialshuttle():
                if level >= 7:
                    ...
                    for i in range(wave_length):
                        ...
                        y = random.randrange(-300-50*level,-100,100)  
...
def score_window():
    ...
    def highscore():
        ...
        for i in highscore_list:
            ...
            screen.blit(label,(WIDTH/2-label.get_width()+140,400 + counter*55))
