...
MILLENNIUM_FALCON_L = pygame.image.load(os.path.join("Space Wars assets", "Millennium-Falcon-left.png"))
MILLENNIUM_FALCON_R = pygame.image.load(os.path.join("Space Wars assets", "Millennium-Falcon-right.png"))
...
class Deathstar(Ship):
    ...
    def healthbar(self, window):
        ...
        pygame.draw.rect(window,GREEN,(self.x,self.y-10,self.ship_img.get_width()*(self.health/self.max_health),10))
