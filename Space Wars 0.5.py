...
# Schiffe
TIE_FIGHTER       = pygame.transform.scale(pygame.image.load(os.path.join("Bilder", "Tie-Fighter.png")),(SMALL,SMALL))
TIE_HUNTER        = pygame.transform.scale(pygame.image.load(os.path.join("Bilder", "Tie-Hunter.png")),(SMALL,SMALL))
STAR_DESTROYER    = pygame.transform.scale(pygame.image.load(os.path.join("Bilder", "Star-Destroyer.png")),(MEDIUM,MEDIUM))
DEATHSTAR         = pygame.transform.scale(pygame.image.load(os.path.join("Bilder", "Death-Star.png")),(LARGE,LARGE))
...
# Gegner           
        for enemy in fleet[:]:
            ...
            if enemy.y >= 0 and random.randrange(0, FPS*5) == 1:
