                    ...
                    for i in range(int(wave_length/6)):
                        ...
                        for enemy in fleet:
                            if enemy.x == stardes.x and enemy.y == stardes.y:
                                fleet.remove(enemy)
                            elif enemy.x+SMALL == stardes.x and enemy.y == stardes.y:
                                fleet.remove(enemy)
                            elif enemy.x == stardes.x and enemy.y+SMALL == stardes.y:
                                fleet.remove(enemy)
                            elif enemy.x+SMALL == stardes.x and enemy.y+SMALL == stardes.y:
                                fleet.remove(enemy)
